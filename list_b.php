           ...
           {  
            ...
            {  
             ...
             <form method="post" action="list_b.php?action=add&id=<?php echo $row["id"]; ?>">  
               ...
               <table border="5">
                <tr><td rowspan="9">  <img class="mySlides product_drag" src="<?php echo $row["image"]; ?>" style="width:400px;height:200px;"  data-id="<?php echo $row['id']; ?>" data-name="<?php echo $row['name']; ?>" data-price="<?php echo $row['price']; ?>" ></td><th colspan="2">Basic Product Information</th></tr>
                <tr><td bgcolor="#f2ffcc">Item Name</td><td><?php echo $row["name"]; ?></td></tr>
                <tr><td bgcolor="#f2ffcc">Brand</td><td>22</td></tr>
                <tr><td bgcolor="#f2ffcc">Condition:</td><td>095498756</td></tr>
                <tr><td bgcolor="#f2ffcc">Colour</td><td>Colour of Computer Systems & Software Engineering</td></tr>
                <tr><td bgcolor="#f2ffcc">Description</td><td>Software Engineering</td></tr>
                <tr><td bgcolor="#f2ffcc">Price:</td><td>RM <?php echo $row["price"]; ?></td></tr>

                <tr><td bgcolor="#f2ffcc">quantity:</td><td>										<input type="text" name="quantity" value="1" />  
                </td></tr>
       ...
       {  
         ...
         {  
          ...
          <tr>  
           ...
           <td><a href="list_b.php?action=delete&id=<?php echo $values["item_id"]; ?>"><span class="text-danger">Remove</span></a></td>  
         </tr>  
         <?php  
